...
(register-handler :account-generation-failure-message
  (u/side-effect!
    (fn [_]
      (when-not (messages/get-by-id chat-consts/account-generation-failure-message-id)
        (sign-up-service/account-generation-failure-message)))))
