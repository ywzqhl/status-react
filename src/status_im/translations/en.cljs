...
(def translations
  {
   ...
   :account-generation-failure-message    "Unfortunately, I cannot generate an account for you without the requied permission. Gimmie the access to your storage and come back."
